...
function APIsetup(villeNormalise){
...
function weatherCmd(msg, args) {
    ...
    weather.getAllWeather(function(error, resApi){
       ...
       if(error){
        console.error(error);//TODO ptet ici le error handling ?
       } 
...
checkIfUndefined.push(pressure);
       ...
       for(var item in checkIfUndefined){
           if(typeof item == 'undefined'){
               msg.channel.send("Désolé, j'ai un résultat qui n'est pas présent !")
           }
       }
